...
class FlavouredTea extends Component {
  ...
  async componentDidMount() {
    const response = await fetch(`http://localhost:8070/product/getCategory/`+"Flavoured Tea");
  ...
  render() {
    return (
      ...
      <div class="container">
        <br/> <br/>
        <h2 className = "text-center fst-italic text-white font-monospace">Flavoured Tea</h2>
        <hr></hr>
        <br/>
        <div className = "row ">
